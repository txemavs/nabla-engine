...
def overpass_query(bounds):
    ...
    s, w, n, e = bounds
    return f'[out:json][timeout:25];(way[building]({s},{w},{n},{e});way["building:part"]({s},{w},{n},{e});way[highway]({s},{w},{n},{e});relation[building]({s},{w},{n},{e});node[natural=tree]({s},{w},{n},{e});way[landuse]({s},{w},{n},{e});way[leisure]({s},{w},{n},{e});way["natural"~"water|wood|beach|sand|scrub|heath|wetland|marsh|grassland"]({s},{w},{n},{e});way[water]({s},{w},{n},{e});way[waterway~"riverbank|dock|river|stream"]({s},{w},{n},{e});relation[landuse]({s},{w},{n},{e});relation[leisure]({s},{w},{n},{e});relation["natural"~"water|wood"]({s},{w},{n},{e});relation[water]({s},{w},{n},{e});relation[waterway~"riverbank"]({s},{w},{n},{e}););out geom;'
